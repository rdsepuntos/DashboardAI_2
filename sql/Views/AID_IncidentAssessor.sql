...
/****** Object:  View [dbo].[AID_IncidentAssessor]    Script Date: 9/24/2026 1:49:19 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[AID_IncidentAssessor]
AS
SELECT        A.StoreID, A.RegOthID, A.InternalNo, A.TitleDesc, ISNULL(sts.StatusDesc, 'N/A') AS Status, A.StartDt, ISNULL(rt.RegRecDesc, 'N/A') AS Type, ISNULL(rst.SubTypeDesc, 'N/A') AS SubType, ISNULL(loctype.LocationTypeName, 'N/A') AS LocationType, ISNULL(A.LocationName, 'N/A') 
                         ...
                         ISNULL(presp.FirstName + ' ' + presp.LastName, 'N/A') AS PersonResponsible,ISNULL(division.DivDeptName, 'N/A') AS Division, ISNULL(department.DivDeptName, 
