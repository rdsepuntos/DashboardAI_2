...
/****** Object:  View [dbo].[AID_HazardReport]    Script Date: 9/24/2026 1:48:59 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[AID_HazardReport]
AS
SELECT        A.StoreID, A.RegOthID, A.InternalNo, A.TitleDesc, ISNULL(sts.StatusDesc, 'N/A') AS Status, A.StartDt, CASE WHEN ISNUMERIC(ISNULL(Score, '0')) = 1 THEN CAST(Score AS numeric(12, 2)) 
...
WHERE        (ISNULL(A.deleted, 0) = 0) AND (ISNULL(A.IsDraft, 0) = 0) AND (ISNULL(A.RegTypeID, 0) = 27)
GO
